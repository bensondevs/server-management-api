...
use App\Observers\SambaShareUserPermissionObserver as Observer;

class SambaShareUserPermission extends Model
{
    use HasFactory;
     ...
     * @var string
     */
    protected $table = 'samba_share_user_permissions';
