...
import OrderInformationTab from './Tabs/OrderInformationTab';
...
export default class PaymentView extends Component {
    ...
    async loadPayment() {
        await axios.get('/dashboard/payments/load?id=' + urlParams().get('id'))
            .then((response) => {
    ...
    render() {
        let payment = this.state.payment
        let card = payment?.card_informations
            ...
            <div className="card card-custom">
                    ...
                    <div className="card-toolbar">
                        <ul className="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                            <li className="nav-item">
                                <a className="nav-link active" data-toggle="tab" href="#payment_information">
                            ...
                            <li className="nav-item mr-3">
                                <a className="nav-link" data-toggle="tab" href="#card_information">
                                    <span className="nav-icon mr-3">
                                    ...
                                    <span className="nav-text font-size-lg">Card Information</span>
                                </a>
                            </li>
                            <li className="nav-item mr-3">
                                <a className="nav-link" data-toggle="tab" href="#order_information">
                                    <span className="nav-icon mr-3">
                                        <span className="svg-icon">
                                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                ...
                <div className="card-body">
                    <div className="tab-content">
                        <PaymentInformationTab payment={payment}>  
                        </PaymentInformationTab>

                        <CardInformationTab card={card}>
                        </CardInformationTab>
                        
                        <OrderInformationTab order={order}>
                        </OrderInformationTab>
                    </div>
                </div>
            </div>
...
if (document.getElementById('payment_view')) {
    ReactDOM.render(<PaymentView />, document.getElementById('payment_view'));
}