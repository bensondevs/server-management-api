...
import { arrayUpdate } from '../Helper'
...
export default class Subnet extends Component {
    constructor(props) {
        ...
        this.renderSubnetsTable = this.renderSubnetsTable.bind(this);
    ...
    async populateSubnets(pageNumber = 1) {
        ...
        let url = `/dashboard/subnets?per_page=${this.state.perPage}&page=${pageNumber}`;
...
if (document.getElementById('subnet')) {
    ReactDOM.render(<Subnet />, document.getElementById('subnet'));
}