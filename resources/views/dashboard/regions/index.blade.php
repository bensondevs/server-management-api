                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        @if (auth()->user()->hasPermissionTo('create regions'))
                            <!--begin::Button-->
                            <a 
                                href="{{ route('dashboard.regions.create') }}" 
                    	...
                    	<tbody>
                    		@foreach ($regions as $region)
	                    		<tr>
	                    			...
	                    			<td>
	                    				<a href="{{ route('dashboard.regions.edit', ['region' => $region]) }}">
						                    <img src="{{ asset('assets/media/svg/icons/General/Edit.svg') }}" />
						                </a>
						                <a href="{{ route('dashboard.regions.delete', ['region' => $region])}}">
