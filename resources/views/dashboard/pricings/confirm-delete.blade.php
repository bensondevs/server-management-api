        ...
        <div class="container">
            <div class="card card-custom col-12">
                ...
                <div class="card-body">
                	...
                	<ul>
                        <li>Priceable Type: {{ $pricing->priceable_type }}</li>
                		<li>Price: {{ $pricing->price }}</li>
                		<li>Currency: {{ $pricing->currency }}</li>
                	</ul>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.pricings.delete') }}" method="POST">
                        @csrf
                        @method('DELETE')
