    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addSupplierForm" action="{{ route('dashboard.suppliers.add') }}" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="modal-footer">
                ...
                <button form="addSupplierForm" type="submit" class="btn btn-dark">Tambahkan</button>
            </div>
        </div>
    </div>
</div>
